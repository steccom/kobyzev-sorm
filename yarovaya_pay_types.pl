...
my $fnameutf="pay_types-t_$y$m$d$h$mi$s.csv";
my $fnamecp="pay_types_$y$m$d$h$mi$s.csv";

open OUT,">$fnameutf";

my $s='"1";"1";"01.01.2004 00:00:00";"";"Банковский перевод"';
print OUT $s."\r\n";
$s='"1";"2";"01.01.2004 00:00:00";"";"Оплата банковской картой(Эквайринг)"';
print OUT $s."\r\n";
close OUT;
